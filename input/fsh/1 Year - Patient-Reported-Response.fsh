Instance: 1YearPatientReported
InstanceOf: Questionnaire
Usage: #definition
Description: "Patient-reported response at 1 year follow-up"
* insert PublicationInstanceRuleset

* name = "1-Year-Patient-Reported"
* title = "Patient reported response at 1 year follow-up"
* status = #draft
