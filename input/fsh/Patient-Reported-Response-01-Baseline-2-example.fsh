Instance: patient-baseline-response
...
* item[=].item[=].text = "What is the patient's ID?"
...
* item[=].item[+].linkId = "EducationLevel-01"
* item[=].item[=].text = "Please indicate your highest level of schooling."
* item[=].item[=].answer.valueCoding.display = "Secondary"
* item[=].item[+].linkId = "RelationshipStatus-01"
* item[=].item[=].text = "Please indicate your current relationship status."
* item[=].item[=].answer.valueCoding.display = "Not married/partnered"
* item[=].item[+].linkId = "MENOPAUSE-01"
* item[=].item[=].text = "What is your current menopausal status?"
* item[=].item[=].answer.valueCoding.display = "Post-menopausei (natural/surgical): if you have not had your period >12 months, caused by natural decline of hormones or due to surgery"
* item[+].linkId = "Baseline-Clinical-Factors-01"
* item[=].text = "Clinical factors"
* item[=].item[0].linkId = "ComorbiditiesSACQ-01"
* item[=].item[=].text = "Have you been told by a doctor that you have any of the following?"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/sacq-patient-comorbidity-history#cancer-within-5yrs "Cancer/other cancer (within last 5 years)"
* item[=].item[+].linkId = "ComorbiditiesSACQ_CancerFU1-01"
* item[=].item[=].text = "Do you receive treatment for cancer/another cancer?"
* item[=].item[=].answer.valueBoolean = false
* item[+].linkId = "Degree-of-Health-EORTC-QLQ-01"
* item[=].text = "Degree of Health - EORTC-QLQ"
* item[=].item[0].linkId = "EORTC-QLQ-Q01-Q05-01"
* item[=].item[=].text = "We are interested in some things about you and your health. Please answer all of the questions yourself by selecting the answer that best applies to you. \n    There are no 'right' or 'wrong' answers. The information that you provide will remain strictly confidential."
* item[=].item[=].item[0].linkId = "EORTCQLQC30_Q01-01"
* item[=].item[=].item[=].text = "Do you have any trouble doing strenuous activities, like carrying a heavy shopping bag or a suitcase?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q02-01"
* item[=].item[=].item[=].text = "Do you have any trouble taking a long walk?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q03-01"
* item[=].item[=].item[=].text = "Do you have any trouble taking a short walk outside of the house?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q04-01"
* item[=].item[=].item[=].text = "Do you need to stay in bed or a chair during the day?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q05-01"
* item[=].item[=].item[=].text = "Do you need help with eating, dressing, washing yourself or using the toilet?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[+].linkId = "EORTC-QLQ-Q06-Q28-01"
* item[=].item[=].text = "During the past week:"
* item[=].item[=].item[0].linkId = "EORTCQLQC30_Q06-01"
* item[=].item[=].item[=].text = "Were you limited in doing either your work or other daily activities?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q07-01"
* item[=].item[=].item[=].text = "Were you limited in pursuing your hobbies or other leisure time activities?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q08-01"
* item[=].item[=].item[=].text = "Were you short of breath?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q09-01"
* item[=].item[=].item[=].text = "Have you had pain?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q10-01"
* item[=].item[=].item[=].text = "Did you need to rest?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q11-01"
* item[=].item[=].item[=].text = "Have you had trouble sleeping?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q12-01"
* item[=].item[=].item[=].text = "Have you felt weak?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q13-01"
* item[=].item[=].item[=].text = "Have you lacked appetite?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q14-01"
* item[=].item[=].item[=].text = "Have you felt nauseated?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q15-01"
* item[=].item[=].item[=].text = "Have you vomited?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q16-01"
* item[=].item[=].item[=].text = "Have you been constipated?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q17-01"
* item[=].item[=].item[=].text = "Have you had diarrhea?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q18-01"
* item[=].item[=].item[=].text = "Were you tired?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q19-01"
* item[=].item[=].item[=].text = "Did pain interfere with your daily activities?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q20-01"
* item[=].item[=].item[=].text = "Have you had difficulty in concentrating on things, like reading a newspaper or watching television?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q21-01"
* item[=].item[=].item[=].text = "Did you feel tense?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q22-01"
* item[=].item[=].item[=].text = "Did you worry?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q23-01"
* item[=].item[=].item[=].text = "Did you feel irritable?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q24-01"
* item[=].item[=].item[=].text = "Did you feel depressed?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q25-01"
* item[=].item[=].item[=].text = "Have you had difficulty remembering things?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q26-01"
* item[=].item[=].item[=].text = "Has your physical condition or medical treatment interfered with your family life?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q27-01"
* item[=].item[=].item[=].text = "Has your physical condition or medical treatment interfered with your social activities?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQC30_Q28-01"
* item[=].item[=].item[=].text = "Has your physical condition or medical treatment caused you financial difficulties?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[+].linkId = "EORTC-QLQ-Q29-Q30-01"
...
* item[=].item[=].item[0].linkId = "EORTCQLQC30_Q29-01"
...
* item[=].item[=].item[0].linkId = "EORTCQLQBR23_Q31-01"
* item[=].item[=].item[=].text = "Did you have a dry mouth?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q32-01"
* item[=].item[=].item[=].text = "Did food and drink taste different than usual?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q33-01"
* item[=].item[=].item[=].text = "Were your eyes painful, irritated or watery?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q34-01"
* item[=].item[=].item[=].text = "Have you lost any hair?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q36-01"
* item[=].item[=].item[=].text = "Did you feel ill or unwell?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q37-01"
* item[=].item[=].item[=].text = "Did you have hot flushes?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q38-01"
* item[=].item[=].item[=].text = "Did you have headaches?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q39-01"
* item[=].item[=].item[=].text = "Have you felt physically less attractive as a result of your disease or treatment?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q40-01"
* item[=].item[=].item[=].text = "Have you been feeling less feminine as a result of your disease or treatment?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q41-01"
* item[=].item[=].item[=].text = "Did you find it difficult to look at yourself naked?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q42-01"
* item[=].item[=].item[=].text = "Have you been dissatisfied with your body?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q43-01"
* item[=].item[=].item[=].text = "Were you worried about your health in the future?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[+].linkId = "EORTC-QLQ-Q44-Q46-01"
* item[=].item[=].text = "During the past four weeks:"
* item[=].item[=].item[0].linkId = "EORTCQLQBR23_Q44-01"
* item[=].item[=].item[=].text = "To what extent were you interested in sex?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q45-01"
* item[=].item[=].item[=].text = "To what extent were you sexually active? (with or without intercourse)"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#1 "Not at all"
* item[=].item[+].linkId = "EORTC-QLQ-Q47-Q53-01"
* item[=].item[=].text = "During the past week:"
* item[=].item[=].item[0].linkId = "EORTCQLQBR23_Q48-01"
* item[=].item[=].item[=].text = "Did you have a swollen arm or hand?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q49-01"
* item[=].item[=].item[=].text = "Was it difficult to raise your arm or to move it sideways?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q50-01"
* item[=].item[=].item[=].text = "Have you had any pain in the area of your affected breast?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q51-01"
* item[=].item[=].item[=].text = "Was the area of your affected breast swollen?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q52-01"
* item[=].item[=].item[=].text = "Was the area of your affected breast oversensitive?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#4 "Very much"
* item[=].item[=].item[+].linkId = "EORTCQLQBR23_Q53-01"
* item[=].item[=].item[=].text = "Have you had skin problems on or in the area of your affected breast (e.g., itchy, dry, flaky)?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#2 "A little"
* item[=].item[=].item[+].linkId = "EORTC QLQ-LMC21-01"
* item[=].item[=].item[=].text = "Have you had tingling hands or feet?"
* item[=].item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/EORTC-QLQ#3 "Quite a bit"
* item[+].linkId = "Degree-of-Health-BreastQ-01"
* item[=].text = "With your breasts in mind, or if you have had a mastectomy, with your breast area in mind, in the past 2 weeks, \n    how satisfied or dissatisfied have you been with:"
* item[=].item[0].linkId = "BREASTQMAST_Q01-01"
* item[=].item[=].text = "How you look in the mirror clothed?"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/Breast-Q#3 "Somewhat satisfied"
* item[=].item[+].linkId = "BREASTQMAST_Q02-01"
* item[=].item[=].text = "How comfortable your bras fit?"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/Breast-Q#1 "Very dissatisfied"
* item[=].item[+].linkId = "BREASTQMAST_Q03-01"
* item[=].item[=].text = "Being able to wear clothing that is more fitted?"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/Breast-Q#2 "Somewhat dissatisfied"
* item[=].item[+].linkId = "BREASTQMAST_Q04-01"
* item[=].item[=].text = "How you look in the mirror unclothed?"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/Breast-Q#2 "Somewhat dissatisfied"
* item[+].linkId = "Degree-of-Health-FACTES-01"
* item[=].text = "Please indicate your response as it applies to the past 7 days:"
* item[=].item[0].linkId = "FACTES_BRM1-01"
* item[=].item[=].text = "I have pain in my joints"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/FACT-ES#2 "Somewhat"
* item[=].item[+].linkId = "FACTES_ES4-01"
* item[=].item[=].text = "I have vaginal discharge"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/FACT-ES#2 "Somewhat"
* item[=].item[+].linkId = "FACTES_ES5-01"
* item[=].item[=].text = "I have vaginal itching/irritation"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/FACT-ES#3 "Quite a bit"
* item[=].item[+].linkId = "FACTES_ES6-01"
* item[=].item[=].text = "I have vaginal bleeding or spotting"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/FACT-ES#0 "Not at all"
* item[=].item[+].linkId = "FACTES_ES7-01"
* item[=].item[=].text = "I have vaginal dryness"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/FACT-ES#0 "Not at all"
* item[=].item[+].linkId = "FACTES_ES8-01"
* item[=].item[=].text = "I have pain or discomfort with intercourse"
* item[=].item[=].answer.valueCoding = http://connect.ichom.org/fhir/CodeSystem/FACT-ES#4 "Very much"